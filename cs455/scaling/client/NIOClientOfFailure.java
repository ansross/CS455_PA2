...
public class NIOClientOfFailure {
	...
	public NIOClientOfFailure(String hostArg, int portArg, int rateArg) throws IOException{
	...
	public static void main(String [] args){
		if(args.length!=3){
			...
			NIOClientOfFailure client;
			try {
				client = new NIOClientOfFailure(args[0], Integer.parseInt(args[1]), Integer.parseInt(args[2]));
				client.startClient();
